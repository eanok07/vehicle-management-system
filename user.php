...
<body id="body">
  ...
  <main id="main">
	...
	<tr>
	<td colspan="2" align="left" ><h2>VIEW USER</h2></td>
	</tr>
	 ...
	 <Td colspan="2">
	   <table width="100%" cellspacing="0" border="1">
		...
		<td> <div align="center"><?php echo $row["adds"];?></div></td>
		...
		<td> <div align="center"><?php echo $row["phone"];?></div></td>
		 ...
		 <td> <div align="center"><?php echo '<a href=delete.php?id='.$row['id'].' style="color:red; font-weight:bold; text-decoration:none;"	 >DELETE</a>'?></div></td>
