...
$fname=$_FILES["im"]["name"];
move_uploaded_file($_FILES["im"]["tmp_name"],"home/" . $fname);



$q = "insert into tb_employee values ('$id','$ename','$gender','$email','$phone','$dob','$address','$tel1', '$mobile','$pass','$fname')";

mysql_query($q) or die (mysql_error());

 echo "<h3 style=font-weight:bold;color:red><center>Successfully Registerd Saved</center></h3>";
