...
<body id="body">
  ...
  <header id="header">
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
		   <li  ><a href="viewmechanic.php">View Mechanic</a></li>
          <li><a href="vehicle.php">Vehicle Add</a></li>
          <li><a href="viewve.php">Alternate Vehicle</a></li>
  ...
  <main id="main">
	...
	<tr>
	<td colspan="2" align="left" ><h2>VIEW ALTERNATE VEHICLE</h2></td>
	</tr>
	 ...
	 <Td colspan="2">
	   <table width="100%" cellspacing="0" border="1">
		<tr bgcolor="#FFFFCC"> 
		<th height="38" bgcolor="#FFFFCC"><span class="style2">Vehicle ID </span></th>
		<th><span class="style2"> Vehicle Name </span></th>
		...
		<td> <div align="center"><?php echo $row["veg"];?></div></td>
		 
		 <td><?php echo "<a href=home/$im><img src=home/$im width=100 height=80></img></a>";?></td>
		 <td> <div align="center"><?php echo '<a href=vdelete.php?id='.$row['id'].' style="color:red; font-weight:bold; text-decoration:none;"	 >DELETE</a>'?></div></td>
