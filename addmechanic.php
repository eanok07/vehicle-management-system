...
<body id="body">
    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
		   ...
		   <li><a href="mechlogin.html">Mechanical Login</a></li>
  ...
  <main id="main">
	...
	<center>
	<form action="mechdata.php" method="post" enctype="multipart/form-data"
	<table  style="border:#3399FF; border:solid 0px; width:500px;  border-radius:15px" height="600px">
	<tr>
	<td colspan="2" align="left" ><h2>ADD MECHANICAL</h2></td>
	</tr>
	 
	 <TR>
	 <Td colspan="2">
	 <table width="100%" border="0" height="600px">
	      <tr>
                                            <td class="style4">
                                              Mechanical ID</td>
                                            <td>
                                               <input name="eno" type="text" value="<?php echo $id1;?>">  
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style4">
                                        ...
                                        <tr>
                                            <td class="style4">
                                                Date of Birth</td>
                                            <td>
                                               <input name="dob" type="date" class="tcal" id="dob">   
                                            </td>
                                        </tr>
										 <tr>
                                            <td class="style4">
                                        ...
                                        <tr>
                                            <td class="style4">
                                                Address</td>
                                            <td>
                                            <textarea name="address" cols="15" rows="2" id="address"></textarea>
                                            </td>
                                        </tr>
										...
										<td colspan="2" align="center"> 
											...
											<input name="submit" type="submit"  value="Submit" class="btn"> 
												<input name="reset" type="submit"  value="Cancel" class="btn"/> 
