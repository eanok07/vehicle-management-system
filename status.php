...
<body id="body">
  ...
  <main id="main">
	...
	<tr>
	<td colspan="2" align="left" ><h2>STATUS</h2></td>
	</tr>
	 ...
	 <Td colspan="2">
	   <table width="100%" cellspacing="0" border="1">
		...
		<th><span class="style2"> Alternative Bike </span></th>
		...
		<?php
		include("include/db.php");
		$q ="select * from tb_post  where uname='$uname'" ;
		$res = mysql_query($q);
		...
		<td> <div align="center"><?php echo $row["st"];?></div></td>
